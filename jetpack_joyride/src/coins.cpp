...
Coin::Coin(float x, float y, color_t color) {
    ...
    for(int i=0;i<n;i++)
    {
        vertex_buffer_data[9*i]=(0.1*cos(i*2*3.14159/n));
        vertex_buffer_data[9*i+1]=(0.1*sin(i*2*3.14159/n));
        vertex_buffer_data[9*i+2]=0.0;

        vertex_buffer_data[9*i+3]=(0.1*cos((i+1)*2*3.14159/n));
        vertex_buffer_data[9*i+4]=(0.1*sin((i+1)*2*3.14159/n));
